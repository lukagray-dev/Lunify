...
import com.android.melodix.databinding.FragmentDuoVideosBinding
import com.android.melodix.duo.ui.viewmodel.DuoViewModel
import com.android.melodix.ui.adapter.VideoAdapter
...
class DuoVideosFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        videoAdapter = VideoAdapter(
            onVideoClick = { video ->
                ...
                com.android.melodix.videoplayer.ui.LocalVideoPlayerActivity.start(
                    requireContext(), 
                    video, 
    ...
    private fun handleVideoOption(video: com.android.melodix.data.model.Video, option: VideoAdapter.VideoOption) {
        when (option) {
    ...
    private fun shareVideo(video: com.android.melodix.data.model.Video) {
        try {
    ...
    private fun showVideoInfo(video: com.android.melodix.data.model.Video) {
        val file = java.io.File(video.path)
        ...
        com.google.android.material.dialog.MaterialAlertDialogBuilder(requireContext(), com.android.melodix.R.style.DarkAlertDialog)
            .setTitle("Video Info")
            .setMessage(info)
