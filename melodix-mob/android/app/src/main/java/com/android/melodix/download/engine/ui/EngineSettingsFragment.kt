...
import com.android.melodix.databinding.FragmentEngineSettingsBinding
...
class EngineSettingsFragment : Fragment() {
    ...
    private fun updateEngineInfoUI(info: com.android.melodix.download.engine.core.EngineInfo) {
