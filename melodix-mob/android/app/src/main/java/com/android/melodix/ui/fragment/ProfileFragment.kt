package com.android.melodix.ui.fragment
...
import com.android.melodix.data.model.User
import com.android.melodix.databinding.FragmentProfileBinding
import com.android.melodix.duo.webrtc.DuoIdManager
...
class ProfileFragment : Fragment() {
    ...
    private fun navigateToDownloads() {
        ...
        activity?.let { act ->
            if (act is com.android.melodix.ui.activity.MainActivity) {
    ...
    private fun openSettings() {
        val intent = Intent(requireContext(), com.android.melodix.settings.SettingsActivity::class.java)
        startActivity(intent)
    }
    
    private fun openEqualizer() {
        val intent = Intent(requireContext(), com.android.melodix.equalizer.ui.EqualizerActivity::class.java)
        startActivity(intent)
    }
    ...
    private fun openPlaylistConverter() {
        val converterFragment = com.android.melodix.converter.ui.fragment.PlaylistConverterFragment.newInstance()
    ...
    private fun openUserAgreement() {
        com.android.melodix.legal.LegalDocumentActivity.startUserAgreement(requireContext())
    }
    
    private fun openPrivacyPolicy() {
        com.android.melodix.legal.LegalDocumentActivity.startPrivacyPolicy(requireContext())
    }
