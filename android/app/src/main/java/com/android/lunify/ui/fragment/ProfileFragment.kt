package com.android.lunify.ui.fragment
...
import com.android.lunify.data.model.User
import com.android.lunify.databinding.FragmentProfileBinding
import com.android.lunify.duo.webrtc.DuoIdManager
...
class ProfileFragment : Fragment() {
    ...
    private fun navigateToDownloads() {
        ...
        activity?.let { act ->
            if (act is com.android.lunify.ui.activity.MainActivity) {
    ...
    private fun openSettings() {
        val intent = Intent(requireContext(), com.android.lunify.settings.SettingsActivity::class.java)
        startActivity(intent)
    }
    
    private fun openEqualizer() {
        val intent = Intent(requireContext(), com.android.lunify.equalizer.ui.EqualizerActivity::class.java)
        startActivity(intent)
    }
    ...
    private fun openUserAgreement() {
        com.android.lunify.legal.LegalDocumentActivity.startUserAgreement(requireContext())
    }
    
    private fun openPrivacyPolicy() {
        com.android.lunify.legal.LegalDocumentActivity.startPrivacyPolicy(requireContext())
    }
