package com.android.lunify.download.engine.ui
...
import com.android.lunify.databinding.FragmentEngineSettingsBinding
...
class EngineSettingsFragment : Fragment() {
    ...
    private fun updateEngineInfoUI(info: com.android.lunify.download.engine.core.EngineInfo) {
