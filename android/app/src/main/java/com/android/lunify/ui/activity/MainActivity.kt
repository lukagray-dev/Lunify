package com.android.lunify.ui.activity
...
import com.android.lunify.ui.fragment.DuoFragment
import com.android.lunify.ui.fragment.DownloadsTabFragment
import com.android.lunify.ui.fragment.ProfileFragment
import com.android.lunify.service.MusicService
import com.android.lunify.ui.adapter.TabPagerAdapter
import com.android.lunify.ui.fragment.PlayerSheetFragment
import com.android.lunify.ui.viewmodel.AuthViewModel
import com.android.lunify.ui.viewmodel.MusicViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun openSettings() {
        ...
        val intent = Intent(this, com.android.lunify.settings.SettingsActivity::class.java)
    ...
    private fun showBrowseTab() {
        ...
        if (supportFragmentManager.findFragmentById(R.id.browseContainer) == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.browseContainer, com.android.lunify.browse.ui.fragment.BrowseFragment.newInstance())
                .commit()
        }
    }
    ...
    override fun onBackPressed() {
        if (binding.drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            val browseFragment = supportFragmentManager.findFragmentById(R.id.browseContainer) 
                as? com.android.lunify.browse.ui.fragment.BrowseFragment
