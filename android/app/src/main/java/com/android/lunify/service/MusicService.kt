package com.android.lunify.service
...
import com.android.lunify.data.PlayCountManager
...
class MusicService : Service() {
    ...
    private fun broadcastPlaybackState(isPlaying: Boolean, song: Song) {
        ...
        // Update widget state
        com.android.lunify.widget.MusicWidgetProvider.updateWidgetState(this, song, isPlaying)
    }
    ...
    private fun getAlbumArt(albumArtUri: Uri?): Bitmap? {
        return try {
            currentSong?.let { song ->
                com.android.lunify.util.AlbumArtUtil.getAlbumArt(
                    contentResolver,
                    albumArtUri,
                    song.path
                )
    ...
    companion object {
        const val ACTION_PLAY = "com.android.lunify.ACTION_PLAY"
        const val ACTION_PAUSE = "com.android.lunify.ACTION_PAUSE"
        const val ACTION_RESUME = "com.android.lunify.ACTION_RESUME"
        const val ACTION_NEXT = "com.android.lunify.ACTION_NEXT"
        const val ACTION_PREVIOUS = "com.android.lunify.ACTION_PREVIOUS"
        const val ACTION_TOGGLE_REPEAT = "com.android.lunify.ACTION_TOGGLE_REPEAT"
        const val ACTION_STOP = "com.android.lunify.ACTION_STOP"
        const val ACTION_SEEK = "com.android.lunify.ACTION_SEEK"
        const val ACTION_ADD_TO_QUEUE = "com.android.lunify.ACTION_ADD_TO_QUEUE"
        ...
        const val BROADCAST_PROGRESS = "com.android.lunify.BROADCAST_PROGRESS"
        const val BROADCAST_PLAYBACK_STATE = "com.android.lunify.BROADCAST_PLAYBACK_STATE"
        const val BROADCAST_NEXT = "com.android.lunify.BROADCAST_NEXT"
        const val BROADCAST_PREVIOUS = "com.android.lunify.BROADCAST_PREVIOUS"
        const val BROADCAST_REPEAT_STATE = "com.android.lunify.BROADCAST_REPEAT_STATE"
        const val BROADCAST_STOP = "com.android.lunify.BROADCAST_STOP"
        const val BROADCAST_PAUSE = "com.android.lunify.BROADCAST_PAUSE"
        const val BROADCAST_RESUME = "com.android.lunify.BROADCAST_RESUME"
        const val BROADCAST_SEEK = "com.android.lunify.BROADCAST_SEEK"
        const val BROADCAST_SONG_CHANGE = "com.android.lunify.BROADCAST_SONG_CHANGE"
        const val BROADCAST_QUEUE_UPDATE = "com.android.lunify.BROADCAST_QUEUE_UPDATE"
    }
}
