...
import com.android.lunify.browse.ui.adapter.SearchAdapter
import com.android.lunify.browse.ui.util.BrowseHistoryManager
...
class BrowseSearchFragment : Fragment() {
    ...
    private fun loadHistoryList() {
        ...
        binding.recyclerView.adapter = SearchAdapter(tracks) { item ->
            val category = viewModel.currentCategory.value ?: com.android.lunify.browse.ui.viewmodel.BrowseCategory.MUSIC
