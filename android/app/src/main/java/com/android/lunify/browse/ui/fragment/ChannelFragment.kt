...
import com.android.lunify.browse.ui.adapter.ChannelTabAdapter
import com.android.lunify.browse.ui.viewmodel.BrowseViewModel
import com.android.lunify.databinding.FragmentChannelBinding
...
class ChannelFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        channel = arguments?.let { BundleCompat.getParcelable(it, ARG_CHANNEL, YouTubeChannel::class.java) }
