package com.android.lunify.download.ui.viewmodel
...
class DownloadsViewModel : ViewModel() {
    ...
    private fun fetchPreviewUrls(content: ExtractedContent) {
        viewModelScope.launch {
            try {
                ...
                val ytDlpEngine = engine as? com.android.lunify.download.engine.ytdlp.YtDlpAndroidEngine
                if (ytDlpEngine == null) {
    ...
    private fun updateDownloadProgress(
        downloadId: String,
        progress: com.android.lunify.download.engine.core.DownloadProgress
    ) {
