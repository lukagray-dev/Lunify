...
class DuoVideosFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        videoAdapter = VideoAdapter(
            onVideoClick = { video ->
                ...
                com.android.lunify.videoplayer.ui.LocalVideoPlayerActivity.start(
                    requireContext(), 
                    video, 
    ...
    private fun handleVideoOption(video: com.android.lunify.data.model.Video, option: VideoAdapter.VideoOption) {
        when (option) {
    ...
    private fun shareVideo(video: com.android.lunify.data.model.Video) {
        try {
    ...
    private fun showVideoInfo(video: com.android.lunify.data.model.Video) {
        val file = java.io.File(video.path)
        ...
        com.google.android.material.dialog.MaterialAlertDialogBuilder(requireContext(), com.android.lunify.R.style.DarkAlertDialog)
            .setTitle("Video Info")
            .setMessage(info)
