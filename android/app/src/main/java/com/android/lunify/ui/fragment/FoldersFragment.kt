...
import com.android.lunify.databinding.FragmentFoldersBinding
import com.android.lunify.ui.adapter.FolderAdapter
    ...
    private fun setupRecyclerView() {
        folderAdapter = FolderAdapter(
            onFolderClick = { folder ->
                ...
                com.android.lunify.ui.activity.FolderContentsActivity.start(
                    requireContext(),
                    folder.name,
                    songs,
                    videos
