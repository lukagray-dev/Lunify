package com.android.melodix.ui.activity
...
import com.android.melodix.auth.AuthManager
import com.android.melodix.auth.GoogleSignInErrorMapper
import com.android.melodix.data.model.Song
import com.android.melodix.data.repository.MusicRepository
import com.android.melodix.databinding.ActivityMainBinding
import com.android.melodix.databinding.LayoutPlayerBarBinding
import com.android.melodix.ui.fragment.DuoFragment
import com.android.melodix.ui.fragment.DownloadsTabFragment
import com.android.melodix.ui.fragment.ProfileFragment
import com.android.melodix.service.MusicService
import com.android.melodix.ui.adapter.TabPagerAdapter
import com.android.melodix.ui.fragment.PlayerSheetFragment
import com.android.melodix.ui.viewmodel.AuthViewModel
import com.android.melodix.ui.viewmodel.MusicViewModel
...
import com.android.melodix.duo.ui.viewmodel.DuoViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private val duoSyncReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            when (intent?.action) {
                com.android.melodix.duo.ui.activity.DuoSongsListActivity.ACTION_DUO_PLAY -> {
                    val song = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                        intent.getParcelableExtra(com.android.melodix.duo.ui.activity.DuoSongsListActivity.EXTRA_SONG, Song::class.java)
                    } else {
                        @Suppress("DEPRECATION")
                        intent.getParcelableExtra(com.android.melodix.duo.ui.activity.DuoSongsListActivity.EXTRA_SONG)
                    }
                    song?.let {
                ...
                com.android.melodix.duo.ui.activity.DuoSongsListActivity.ACTION_DUO_PAUSE -> {
                    android.util.Log.d("MainActivity", "DuoSongsListActivity pause - syncing with Duo")
                    duoViewModel.syncPause()
                }
                com.android.melodix.duo.ui.activity.DuoSongsListActivity.ACTION_DUO_RESUME -> {
    ...
    private fun openSettings() {
        ...
        val intent = Intent(this, com.android.melodix.settings.SettingsActivity::class.java)
        startActivity(intent)
    }

    private fun openEqualizer() {
        // Open Equalizer Activity
        val intent = Intent(this, com.android.melodix.equalizer.ui.EqualizerActivity::class.java)
        startActivity(intent)
    }

    private fun openUserAgreement() {
        com.android.melodix.legal.LegalDocumentActivity.startUserAgreement(this)
    }

    private fun openPrivacyPolicy() {
        com.android.melodix.legal.LegalDocumentActivity.startPrivacyPolicy(this)
    }
    ...
    private fun showBrowseTab() {
        ...
        if (supportFragmentManager.findFragmentById(R.id.browseContainer) == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.browseContainer, com.android.melodix.browse.ui.fragment.BrowseFragment.newInstance())
                .commit()
        }
    }
    ...
    private fun observeViewModel() {
        ...
        viewModel.currentSong.observe(this) { song ->
            song?.let {
                ...
                com.android.melodix.util.AlbumArtUtil.loadAlbumArtWithFallback(
                    Glide.with(this),
                ...
                com.android.melodix.util.AlbumArtUtil.applyPlayerBarTheming(
        ...
        lifecycleScope.launch {
            duoViewModel.connectionState.collect { state ->
                val wifiDirectConnected = state is com.android.melodix.duo.data.model.DuoConnectionState.Connected
                isDuoConnected = wifiDirectConnected || duoViewModel.webRTCConnectionState.value is com.android.melodix.duo.webrtc.model.WebRTCConnectionState.Connected
        ...
        lifecycleScope.launch {
            duoViewModel.webRTCConnectionState.collect { state ->
                val webRTCConnected = state is com.android.melodix.duo.webrtc.model.WebRTCConnectionState.Connected
                isDuoConnected = webRTCConnected || duoViewModel.connectionState.value is com.android.melodix.duo.data.model.DuoConnectionState.Connected
    ...
    private fun updateDrawerHeader(user: com.android.melodix.data.model.User?) {
    ...
    private fun registerReceivers() {
        ...
        val duoSyncFilter = IntentFilter().apply {
            addAction(com.android.melodix.duo.ui.activity.DuoSongsListActivity.ACTION_DUO_PLAY)
            addAction(com.android.melodix.duo.ui.activity.DuoSongsListActivity.ACTION_DUO_PAUSE)
            addAction(com.android.melodix.duo.ui.activity.DuoSongsListActivity.ACTION_DUO_RESUME)
        }
    ...
    override fun onBackPressed() {
        if (binding.drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            val browseFragment = supportFragmentManager.findFragmentById(R.id.browseContainer) 
                as? com.android.melodix.browse.ui.fragment.BrowseFragment
