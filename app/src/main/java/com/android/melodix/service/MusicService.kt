package com.android.melodix.service
...
import com.android.melodix.data.PlayCountManager
import com.android.melodix.data.model.Song
import com.android.melodix.equalizer.manager.EqualizerManager
...
class MusicService : Service() {
    ...
    private fun broadcastPlaybackState(isPlaying: Boolean, song: Song) {
        ...
        // Update widget state
        com.android.melodix.widget.MusicWidgetProvider.updateWidgetState(this, song, isPlaying)
    }
    ...
    private fun getAlbumArt(albumArtUri: Uri?): Bitmap? {
        return try {
            currentSong?.let { song ->
                com.android.melodix.util.AlbumArtUtil.getAlbumArt(
                    contentResolver,
                    albumArtUri,
                    song.path
                )
    ...
    companion object {
        const val ACTION_PLAY = "com.android.melodix.ACTION_PLAY"
        const val ACTION_PAUSE = "com.android.melodix.ACTION_PAUSE"
        const val ACTION_RESUME = "com.android.melodix.ACTION_RESUME"
        const val ACTION_NEXT = "com.android.melodix.ACTION_NEXT"
        const val ACTION_PREVIOUS = "com.android.melodix.ACTION_PREVIOUS"
        const val ACTION_TOGGLE_REPEAT = "com.android.melodix.ACTION_TOGGLE_REPEAT"
        const val ACTION_STOP = "com.android.melodix.ACTION_STOP"
        const val ACTION_SEEK = "com.android.melodix.ACTION_SEEK"
        const val ACTION_ADD_TO_QUEUE = "com.android.melodix.ACTION_ADD_TO_QUEUE"
        ...
        const val BROADCAST_PROGRESS = "com.android.melodix.BROADCAST_PROGRESS"
        const val BROADCAST_PLAYBACK_STATE = "com.android.melodix.BROADCAST_PLAYBACK_STATE"
        const val BROADCAST_NEXT = "com.android.melodix.BROADCAST_NEXT"
        const val BROADCAST_PREVIOUS = "com.android.melodix.BROADCAST_PREVIOUS"
        const val BROADCAST_REPEAT_STATE = "com.android.melodix.BROADCAST_REPEAT_STATE"
        const val BROADCAST_STOP = "com.android.melodix.BROADCAST_STOP"
        const val BROADCAST_PAUSE = "com.android.melodix.BROADCAST_PAUSE"
        const val BROADCAST_RESUME = "com.android.melodix.BROADCAST_RESUME"
        const val BROADCAST_SEEK = "com.android.melodix.BROADCAST_SEEK"
        const val BROADCAST_SONG_CHANGE = "com.android.melodix.BROADCAST_SONG_CHANGE"
        const val BROADCAST_QUEUE_UPDATE = "com.android.melodix.BROADCAST_QUEUE_UPDATE"
    }
}
