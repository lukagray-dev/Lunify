package com.android.melodix.duo.ui.viewmodel
...
import com.android.melodix.data.model.Video
import com.android.melodix.data.model.Artist
import com.android.melodix.data.model.Album
import com.android.melodix.data.model.Folder
import com.android.melodix.duo.data.model.*
import com.android.melodix.duo.data.repository.DuoRepository
import com.android.melodix.duo.webrtc.SignalingManager
import com.android.melodix.duo.webrtc.WebRTCRepository
import com.android.melodix.duo.webrtc.model.WebRTCConnectionState
...
class DuoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // Chat state
    private val _chatMessages = MutableStateFlow<List<com.android.melodix.duo.chat.model.ChatMessage>>(emptyList())
    val chatMessages: StateFlow<List<com.android.melodix.duo.chat.model.ChatMessage>> = _chatMessages.asStateFlow()
    ...
    private fun handleIncomingChatMessage(payload: ChatMessagePayload) {
        ...
        val message = com.android.melodix.duo.chat.model.ChatMessage(
            id = payload.messageId,
            text = payload.text,
            senderName = payload.senderName,
            isFromMe = false,
            status = com.android.melodix.duo.chat.model.MessageStatus.DELIVERED
        )
    ...
    private fun handleIncomingVoiceMessage(payload: VoiceMessagePayload) {
        val message = com.android.melodix.duo.chat.model.ChatMessage(
            ...
            isFromMe = false,
            status = com.android.melodix.duo.chat.model.MessageStatus.DELIVERED,
            type = com.android.melodix.duo.chat.model.MessageType.VOICE,
    ...
    private fun handleMessageDelivered(messageId: String) {
        ...
        val updatedMessages = _chatMessages.value.map { msg ->
            if (msg.id == messageId && msg.isFromMe) {
                ...
                msg.copy(status = com.android.melodix.duo.chat.model.MessageStatus.DELIVERED)
            } else msg
        }
    ...
    private fun handleMessageRead(messageId: String) {
        ...
        val updatedMessages = _chatMessages.value.map { msg ->
            if (msg.id == messageId && msg.isFromMe) {
                ...
                msg.copy(status = com.android.melodix.duo.chat.model.MessageStatus.READ)
            } else msg
        }
        _chatMessages.value = updatedMessages
    }
    ...
    fun markMessagesAsRead() {
        ...
        viewModelScope.launch {
            _chatMessages.value
                .filter { !it.isFromMe && it.status != com.android.melodix.duo.chat.model.MessageStatus.READ }
                .forEach { msg ->
    ...
    fun sendChatMessage(text: String) {
        ...
        val message = com.android.melodix.duo.chat.model.ChatMessage(
            ...
            isFromMe = true,
            status = com.android.melodix.duo.chat.model.MessageStatus.SENDING
        )
        ...
        viewModelScope.launch {
            try {
                ...
                val newStatus = if (success) {
                    com.android.melodix.duo.chat.model.MessageStatus.SENT
                } else {
                    com.android.melodix.duo.chat.model.MessageStatus.FAILED
                }
                ...
                _chatMessages.value = _chatMessages.value.map { msg ->
                    if (msg.id == messageId) msg.copy(status = com.android.melodix.duo.chat.model.MessageStatus.FAILED) else msg
                }
            }
        }
