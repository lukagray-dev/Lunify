package com.android.melodix.browse.data.repository
...
import com.android.melodix.browse.data.mapper.YouTubeMapper.toYouTubeChannel
import com.android.melodix.browse.data.mapper.YouTubeMapper.toYouTubePlaylist
import com.android.melodix.browse.data.mapper.YouTubeMapper.toYouTubeVideo
import com.android.melodix.browse.data.model.YouTubeChannel
import com.android.melodix.browse.data.model.YouTubeHomeContent
import com.android.melodix.browse.data.model.YouTubePlaylist
import com.android.melodix.browse.data.model.YouTubeSearchResult
    ...
    fun getHomeContent(): Flow<Result<YouTubeHomeContent>> = flow {
        try {
            ...
            if (trendingResponse.isSuccessful) {
                ...
                // Get melodix category videos for recommended
    ...
    fun getRelatedVideos(videoId: String): Flow<Result<List<YouTubeVideo>>> = flow {
        try {
            ...
            if (videoResponse.isSuccessful) {
                ...
                val searchQuery = video?.snippet?.title?.split(" ")?.take(3)?.joinToString(" ") ?: "melodix"
