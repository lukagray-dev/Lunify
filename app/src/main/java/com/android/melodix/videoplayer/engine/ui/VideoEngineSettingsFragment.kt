...
import com.android.melodix.databinding.FragmentVideoEngineSettingsBinding
...
class VideoEngineSettingsFragment : Fragment() {
    ...
    private fun updateEngineInfoUI(info: com.android.melodix.videoplayer.engine.core.VideoEngineInfo) {
