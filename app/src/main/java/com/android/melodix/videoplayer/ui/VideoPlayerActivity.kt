package com.android.melodix.videoplayer.ui
...
import com.android.melodix.databinding.ActivityVideoPlayerBinding
    ...
    private fun showEngineNotInstalledDialog() {
        androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setPositiveButton("Go to Settings") { _, _ ->
                startActivity(Intent(this, com.android.melodix.settings.SettingsActivity::class.java))
                finish()
            }
