package com.android.melodix.download.ui.viewmodel
...
import com.android.melodix.download.data.model.DownloadFormat
import com.android.melodix.download.data.model.DownloadItem
import com.android.melodix.download.data.model.DownloadStatus
import com.android.melodix.download.data.model.ExtractedContent
import com.android.melodix.download.engine.core.DownloadProgressStatus
import com.android.melodix.download.engine.core.EngineInfo
import com.android.melodix.download.engine.core.EngineNotInstalledException
import com.android.melodix.download.engine.manager.EngineManager
import com.android.melodix.download.engine.manager.EngineManagerFactory
import com.android.melodix.download.manager.DownloadStateManager
import com.android.melodix.videoplayer.preview.PreviewManager
...
class DownloadsViewModel : ViewModel() {
    ...
    private fun fetchPreviewUrls(content: ExtractedContent) {
        viewModelScope.launch {
            try {
                ...
                val ytDlpEngine = engine as? com.android.melodix.download.engine.ytdlp.YtDlpAndroidEngine
                if (ytDlpEngine == null) {
    ...
    private fun updateDownloadProgress(
        downloadId: String,
        progress: com.android.melodix.download.engine.core.DownloadProgress
    ) {
