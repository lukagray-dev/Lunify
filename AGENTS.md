...
3. Industrial Architecture Standards
    ...
    - Follow principles such as:
      ...
      - <500 LOC/file
      - Always include large robust tests while writing code
        - Seperate sibling files for tests (not inline)
...
5. Production-Grade Code Only
    ...
    - All code must be:
      ...
      - Error-handled
      - Clearly organized
      - ***WELL DETAILED INLINE COMMENTS IN EVERY FILE, LIKE EXPLAINING TO A NEWBIE FRIEND.***
    - Use realistic architecture, naming, and structure.
6. Structured Reasoning Pipeline (Always internally follow)
    - Context acquisition
...
8. Output Quality Standard (Every response must)
    - Be actionable
